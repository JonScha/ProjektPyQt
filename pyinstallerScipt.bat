...
pyinstaller --onedir --hidden-import _internal/Plugins.standardPlugins --add-data ./src/_internal/Plugins:./Plugins --add-data ./src/_internal/Plugins/standardPlugins.py:./Plugins %1
